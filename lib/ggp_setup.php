...
function register_ggp_game_setup(){
  ...
  register_setting('ggp_game_setup_group','ggp_init_emission_trading');
    ...
    <div class="metabox-holder">
      <div class="postbox">
        ...
        <div class="inside">
          ...
          <tr><td>CO2排出権取引金額</td><td><input type="text" id="ggp_init_emission_trading" name="ggp_init_emission_trading" value="<?php echo get_option('ggp_init_emission_trading'); ?>">万円／200kg</td></tr>
